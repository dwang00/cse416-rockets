...
function MyComponent(){
    return (
        <div>
            <div style={{position: "absolute", top: "2690px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "2690px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", top: "3210px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "3210px", width: '700px', height: '400px', textAlign:"center"}}>
