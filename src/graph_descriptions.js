...
function MyComponent(){
    return (
        <div>
            <div style={{position: "absolute", top: "2670px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "2670px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", top: "3190px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "3190px", width: '700px', height: '400px', textAlign:"center"}}>
