...
function MyComponent(){
    return (
        <div>
            <div style={{}}>According to the US Census, 26.8% of the Alabama population is black and 64.7% is white.
            ...
            <div style={{}}>According to the US Census, 68% of the Delaware population is white, 23.8% is black and
            ...
            <div style={{}}>The scatter plot representing Alabama shows a correlation between the percent of african
            ...
            <div style={{}}>The scatter plot representing Delaware shows a correlation between the percent of african
