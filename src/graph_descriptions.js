...
function MyComponent(){
    return (
        <div>
            <div style={{position: "absolute", top: "2450px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "2450px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", top: "2960px", width: '700px', height: '400px', textAlign:"center"}}>
            ...
            <div style={{position: "absolute", left:"50%", top: "2960px", width: '700px', height: '400px', textAlign:"center"}}>
